...
@NamedQueries({
	@NamedQuery(name = "EventCause.getAll", query = "SELECT ec FROM Event_Cause ec"),
	@NamedQuery(name = "EventCause.findById", query = "select ec from Event_Cause ec where ec.ecId=:id"), 
