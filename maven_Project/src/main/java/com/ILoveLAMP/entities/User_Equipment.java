...
@NamedQueries({
	...
	@NamedQuery(name = "User_Equipment.findUserEquipmentByModel", query = "select ue from User_Equipment ue where ue.model=:model"),
	@NamedQuery(name = "User_Equipment.getUeIdByModel", query = "select ue.userEquipmentId from User_Equipment ue where ue.model=:model"),
})
