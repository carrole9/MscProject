...
@NamedQueries({
	...
	@NamedQuery(name = "Base_Data.IMSIandCallFailuresfindByTime", query = "select distinct(bd.imsi) from Base_Data bd where bd.dateTime between :firsttime and :secondtime"),
