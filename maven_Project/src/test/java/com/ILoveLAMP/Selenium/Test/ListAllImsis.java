...
public class ListAllImsis {
  ...
  @Test
  public void testListAllImsis() throws Exception {
    driver.get(baseUrl);
    ...
    driver.findElement(By.xpath(".//*[@id='mySTime']")).sendKeys("11/01/2013 00:00");
    Thread.sleep(1000);
    
    driver.findElement(By.xpath(".//*[@id='myETime']")).sendKeys("21/01/2013 00:00");
    Thread.sleep(1000);
    
    long startTime = System.currentTimeMillis();
    driver.findElement(By.id("suppSub1")).click();
    
    boolean status = driver.findElement(By.xpath(".//*[@id='myIMSI']")).isDisplayed();
