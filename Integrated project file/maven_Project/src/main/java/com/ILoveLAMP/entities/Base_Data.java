...
public class Base_Data implements Serializable{
	...
	public Base_Data(Integer dataId, String dateTime, Integer cellId,
			Integer duration, String neVersion, String imsi,
			String hier3Id, String hier32Id, String hier321Id,
			Failure failure, Event_Cause eventCause, Operator operator,
